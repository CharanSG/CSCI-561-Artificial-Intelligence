...
p2.availNbr = ['B','C','A'];  # charan TBD put everything else as no new selection 
#validMap['A'] = 0;
#validMap['C'] = 0;
DEPTH = 0; # 0 TO 4
p1.sump1 = 0
...
recursiveCall(p1,p2,validMap,True,0,DEPTH) # PASS INITIAL DEPTH AS 2 IF 0 AND 1 DEPTH ARE ALREADY MENTIONED
